...
const url_array_test_A= [
    ...
    img_url:'https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/LD-HERO-25T-Tools-Tool-Savings-MOB-B.jpg',
    ...
    img_url:'https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/LD-HERO-25T-Power-Tools-MOB-B.jpg',
    ...
    img_url:'https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/LD-HERO-25T-Hand-Tools-MOB-B.jpg',
    ...
    img_url:'https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/2021LaborDayTrimmersTestHero1MOB.jpg',
    ...
    img_url:'https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/2021LaborDayLawnMowersTestHero1MOB.jpg',
    ...
    img_url:'https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/2021LaborDayRidingLawnMowersTestHero1MOB.jpg',
	                ...
	                if(document.querySelectorAll("div.content_image").length > 0)
                     {
                        ...
                        if (url.includes('/c/'))
                        {
                            ...
                            let UpdatedHtml ='<a href="https://www.homedepot.com/b/Tools/Free-Shipping-To-Home/Special-Values/N-5yc1vZc1xyZ7Z25egxd?NCNI-5"><picture><source media="(min-width: 640px)" srcset="hhttps://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/LD-HERO-25T-Tools-Tool-Savings-MOB-B.jpg"><source media="(max-width: 640px)" srcset="https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/LD-HERO-25T-Tools-Tool-Savings-MOB-B.jpg"><img src="https://contentgrid.thdstatic.com/hdus/en_US/DTCCOMNEW/fetch/NexGen/ContentPage/LD-HERO-25T-Tools-Tool-Savings-MOB-B.jpg" class="stretchy" alt="SAVINGS + FREE  2-DAY DELIVERY On Select Tools, Tool  Storage &amp; Accessories Shop Now" title=""></picture></a>'
